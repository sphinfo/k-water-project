        ...
        <ul className="map-widget-vertical-block">
            <button className={`map-right-bt ${activeType === 'LineString' ? 'active' : ''}`} onClick={()=>{drawController('LineString')}}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" viewBox="0 0 20 14" fill="none">
                    <g clip-path="url(#clip0_505_23595)">
                        ...
                        <path d="M5.25011 4.83331H1.55566V12.4166H18.4446V4.83331H14.2223M5.25011 4.83331V7.54165M5.25011 4.83331H9.47233M9.47233 4.83331V8.08331M9.47233 4.83331H14.2223M14.2223 4.83331V7.54165" stroke="#3D3D3D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </g>
                    <defs>
            ...
            <button className="map-right-bt" onClick={()=>{removeDraw()}}>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_570_5449)">
