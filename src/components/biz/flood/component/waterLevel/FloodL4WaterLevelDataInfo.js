...
const FloodL4WaterLevelDataInfo = () => {
    ...
    return (
        <>
            <div style={{position: 'fixed', bottom: 20, left: 400, width: 600, height: 50, display: 'flex'}}>
                <h3>원천 데이터 정보</h3>
                <h3>C-Band SAR</h3>
                <h3>다중분광 위성영상</h3>
                <h3>.....</h3>
...
export default React.memo(FloodL4WaterLevelDataInfo);
