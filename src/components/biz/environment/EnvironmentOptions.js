    ...
    const namesRef = useRef([
        {
            ...
            code:'DAM',
            items: [
                {name:'용담댐', code:'YONGDAM', xmin: 127.22692739874623, ymin: 35.77281149769304, xmax: 127.7857552328893, ymax: 36.01009776065693, data:[38684800,	33514600,	196375800,	720103600,	13928000], img: YDD},
                {name:'대청댐', code:'DAECHEONG', xmin: 127.22924890169264, ymin: 36.311540601990295, xmax: 127.76100028250217, ymax: 36.535801397391765, data:[77435600,	64474000,	223973100,	464880200,	75708500], img: DCD},
                {name:'안동댐', code:'ANDONG', xmin: 128.40710758959597, ymin: 36.43154992312028, xmax: 129.20411552482912, ymax: 36.76666637977058, data:[94998600,	183578700,	346660300,	1014115700,	20827600], img: ADD},
                {name:'운문댐', code:'UNMUN',  xmin: 128.7701224190297, ymin: 35.6601755367662, xmax: 129.08348908785123, ymax: 35.79360233550989, data:[8555500,	11694500,	47919600,	173438400,	1725200], img: UMD},
                {name:'사연댐', code:'SAYEON', xmin: 129.10610656368257, ymin: 35.55608749038927, xmax: 129.26751087118762, ymax: 35.62495749231511, data:[2579200,	4873500,	23816800,	66608400,	4092800], img: SYD},
